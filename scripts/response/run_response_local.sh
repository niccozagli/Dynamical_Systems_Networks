...
# Example:
#   ./scripts/response/run_response_local.sh \
#     --unperturbed-dir results/linear_response/poisson_annealed/unperturbed_runs/critical/n1000/graph_0001 \
#     --response-config configs/linear_response/poisson_annealed/perturbed_runs/critical/response_config_degree_weighted_alpha_rot_gamma1p0_eps01.json \
